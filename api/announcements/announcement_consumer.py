...
class AnnouncementConsumer:
    def __init__(self, consumer: Consumer, announcement_redis_storage: AnnouncementRedisStorage):
    ...
    async def process(self):
        async for message in self._consumer.messages():
            ...
            await self._announcement_redis_storage.add_announcement(to=task.to, announcement=task.announcement)
