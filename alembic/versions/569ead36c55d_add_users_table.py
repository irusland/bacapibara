...
def upgrade() -> None:
    ...
    op.create_index('last_login_id_name_index', 'users', ['last_login', 'id', 'name'], unique=False, postgresql_ops={'name': 'DESC'})
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('last_login_id_name_index', table_name='users', postgresql_ops={'name': 'DESC'})
    op.drop_table('users')
    # ### end Alembic commands ###
